...
const info = () => {
    return (
        <div className='grid grid-cols-1 lg:grid-cols-3 gap-5 my-12'>
            ...
            <InfoCard description='Near Dhaka College,in front of Dhaka new Market,Dhanmondi,Dhaka-1280' bgColor='bg-[#3A4256]' cardTitle='Our Location' img={marker}></InfoCard>
